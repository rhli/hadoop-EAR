  ...
  static class DistRaidInputFormat implements InputFormat<Text, PolicyInfo> {
    ...
    public InputSplit[] getSplits(JobConf job, int numSplits)
      ...
      for(String rackKey : sortedKeyList) {
        ...
        long startPos = idxRange[0]==0? 0:stripeOffset.get(idxRange[0]-1)-1;
        long endPos = stripeOffset.get(idxRange[1])==prev?stripeOffset.get(idxRange[1]):
          (stripeOffset.get(idxRange[1])-1);
